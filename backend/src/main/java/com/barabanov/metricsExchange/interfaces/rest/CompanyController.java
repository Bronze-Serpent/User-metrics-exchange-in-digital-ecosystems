...
public class CompanyController {
    ...
    //TODO: нет обновлений у компаний? - добавить. По крайней мере чтобы можно было менять описание + Суперпользователь не может удалять пользователей системы (это может и нормально c учётом связей в БД. Или мб сделать удаление но только админов компании и валидировать это на бэке)?
